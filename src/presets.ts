...
export const presets: Record<string, string[]> = {
    ...
    nextjs: ['__nextjs_', '_next/webpack-hmr', '_vercel/'],

    /** Vite dev-server module and HMR requests */
    vite: ['/@vite/', '/@react-refresh', '/@fs/'],

    /** Common third-party analytics and tracking services */
    noAnalytics: ['google-analytics.com', 'analytics.google.com', 'googletagmanager.com', 'hotjar.com', 'segment.io', 'mixpanel.com'],
};
