...
class InteractivePanel implements IInteractivePanel {
    ...
    private createOpenButton() {
        ...
        container.innerHTML = `<button onclick='rilogLibOnOpen()' style='${buttonStyles}'><img src='https://i.ibb.co/nwm3Dxx/rilog-logo.png' href='Rilog'/></button>`;
    ...
    private createBody(uToken = "") {
        ...
        container.innerHTML = `<div style='${tokenContainerStyles}'>
                ...
                <div style='${inputContainerStyles}'>
                    ...
                    <button onclick='rilogLibCopyToken()' style='${buttonCopyStyles}'><img src='https://i.ibb.co/wBxF3GX/rilog-copy-icon.png' alt='copy'></button>
                </div>
            ...
            <div style='${footerStyles}'>
                <button onclick='rilogLibOnClose()' style='${buttonCloseStyles}'>Close</button>
            </div>`;
